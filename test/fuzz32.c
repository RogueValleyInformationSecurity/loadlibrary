// Example 32-bit DLL for fuzzing demonstration
// Compile with: i686-w64-mingw32-gcc -shared -nostdlib -e _DllMainCRTStartup -o fuzz32.dll fuzz32.c
#include <stdint.h>
...
// Entry point for -nostdlib (use cdecl to avoid stdcall decoration)
int __attribute__((cdecl)) DllMainCRTStartup(void *hinstDLL, uint32_t fdwReason, void *lpvReserved) {
