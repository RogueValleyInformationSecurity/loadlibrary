...
// Entry point for -nostdlib (use cdecl to avoid name decoration)
int __attribute__((cdecl)) _DllMainCRTStartup(void *hinstDLL, uint32_t fdwReason, void *lpvReserved) {
