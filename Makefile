CFLAGS  = -O3 -march=native -ggdb3 -m32 -std=gnu99 -fshort-wchar -Wall -Wextra -Wno-multichar -Iinclude -mstackrealign
...
clean:
	rm -f a.out core *.o *.d core.* vgcore.* gmon.out mpclient
